...
The JSON object must have the following structure:
{
  ...
  "score": 85,
  "summary": "A single, brief paragraph summarizing ONLY the most critical findings and risks for this file."
}
...
- Score & Summary: An integer score from 0-100 and a very brief summary.
  `;
};
...
The JSON object must have the following structure:
{
  ...
  "fix": [ { "line": 50, "explanation": "A very brief explanation of the fix.", "code": "the corrected code snippet" } ],
  "score": 85,
  "summary": "A single, brief paragraph summarizing ONLY the most critical findings and risks introduced by these changes."
}
  `;
};
...
- Be direct and technical. No conversational fluff.
- All descriptions must be a single, concise sentence.
- Do not include a summary or a score.
